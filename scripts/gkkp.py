...
def generate_gkkp(database,qe_save,elph_save,y_dir,scheduler):
    """
    Read gkkp from dfpt calculation
    """
    # Generate SAVE folder if nscf_path is given
    if qe_save != "": generate_save.generate_save(database,qe_save,y_dir,scheduler)
...
if __name__ == "__main__":
    ...
    generate_gkkp(database,nscf_dir,elph_dir,yambo_dir,scheduler)
